...
# Plot CPU, Memory, Disk I/O over time
plt.figure(figsize=(12, 6))
plt.plot(host_metrics["Timestamp"], host_metrics["CPU_Usage"], label="CPU Usage (%)")
plt.plot(host_metrics["Timestamp"], host_metrics["Mem_Avail_MB"], label="Available Memory (MB)")
...
plt.plot(entropy_series.index, entropy_series.values, label="Avg File Entropy")
plt.xlabel("Time")
plt.ylabel("Entropy")
