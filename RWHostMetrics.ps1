...
# ⏱️ Main Loop with Phases
for ($i = 1; $i -le $iterations; $i++) {
    Write-Host "`n[Cycle $i] - Idle Phase (10 mins)"
    ...
    Write-Host "[Cycle $i] - Read Phase (10 mins)"
